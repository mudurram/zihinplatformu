// ==========================================================
// 🎯 Bölünmüş Dikkat Oyun Sonuç Ekranı
// ==========================================================
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const oyunAdi = localStorage.getItem("bolunmusDikkatOyunAdi") || "Bölünmüş Dikkat Oyunu";
  document.getElementById("oyunAdi").textContent = oyunAdi;

  // İstatistikleri göster
  if (sonOyunSonuc.oyun && sonOyunSonuc.oyun.includes("bolunmus_dikkat")) {
  ...
  document.getElementById("dikkatMenuBtn").onclick = () => {
    localStorage.removeItem("bolunmusDikkatOyunId");
    localStorage.removeItem("bolunmusDikkatOyunAdi");
