// ==========================================================
// 🎯 Engel Baskılama Oyun Sonuç Ekranı
// ==========================================================
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const oyunAdi = localStorage.getItem("engelBaskilamaOyunAdi") || "Engel Baskılama Oyunu";
  document.getElementById("oyunAdi").textContent = oyunAdi;

  // İstatistikleri göster
  if (sonOyunSonuc.oyun && sonOyunSonuc.oyun.includes("engel_baskilama")) {
  ...
  document.getElementById("dikkatMenuBtn").onclick = () => {
    localStorage.removeItem("engelBaskilamaOyunId");
    localStorage.removeItem("engelBaskilamaOyunAdi");
