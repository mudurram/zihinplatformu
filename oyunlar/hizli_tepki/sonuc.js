...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const oyunAdi = localStorage.getItem("hizliTepkiOyunAdi") || "Hızlı Tepki Oyunu";
  document.getElementById("oyunAdi").textContent = oyunAdi;

  // İstatistikleri göster
  if (sonOyunSonuc.oyun && sonOyunSonuc.oyun.includes("hizli_tepki")) {
  ...
  document.getElementById("dikkatMenuBtn").onclick = () => {
    localStorage.removeItem("hizliTepkiOyunId");
    localStorage.removeItem("hizliTepkiOyunAdi");
