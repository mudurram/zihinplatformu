...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const oyunAdi = localStorage.getItem("seciciDikkatOyunAdi") || "Seçici Dikkat Oyunu";
  document.getElementById("oyunAdi").textContent = oyunAdi;

  // İstatistikleri göster
  if (sonOyunSonuc.oyun && sonOyunSonuc.oyun.includes("secici_dikkat")) {
  ...
  document.getElementById("dikkatMenuBtn").onclick = () => {
    localStorage.removeItem("seciciDikkatOyunId");
    localStorage.removeItem("seciciDikkatOyunAdi");
